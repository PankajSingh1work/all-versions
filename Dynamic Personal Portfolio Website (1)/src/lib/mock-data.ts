...
import { Project, Certification, BlogPost, Profile, Service } from './supabase';
...
export const mockServices: Service[] = [
  {
    ...
    description: 'Build modern, scalable web applications using cutting-edge technologies tailored to your specific business needs.',
    long_description: `I specialize in creating custom web applications that solve real business problems. From simple landing pages to complex enterprise applications, I deliver solutions that are fast, secure, and scalable.

My development process focuses on understanding your unique requirements and creating a solution that not only meets your current needs but can grow with your business. I use modern frameworks and best practices to ensure your application is maintainable and future-proof.`,
    image_url: 'https://images.unsplash.com/photo-1730130054404-c2bd8e7038c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB3ZWIlMjBkZXZlbG9wbWVudHxlbnwxfHx8fDE3NTY2ODQ5MTl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    category: 'Web Development',
    status: 'available',
    featured: true,
    features: [
  ...
  },
  {
    ...
    description: 'Create intuitive and engaging user experiences through research-driven design and user-centered approach.',
    long_description: `I help businesses create digital experiences that users love. My design process is rooted in user research and data-driven decisions, ensuring that every design choice serves a purpose and improves the user experience.

From wireframes to high-fidelity prototypes, I work closely with you to understand your users and create interfaces that are not only beautiful but also functional and accessible.`,
    ...
    tools: ['Figma', 'Adobe Creative Suite', 'Principle', 'UserTesting', 'Miro', 'InVision'],
    deliverables: [
  ...
  },
  {
    ...
    description: 'Develop high-performance mobile applications for iOS and Android using React Native and Flutter.',
    long_description: `Bring your ideas to mobile with cross-platform applications that deliver native performance. I specialize in React Native and Flutter development, allowing you to reach both iOS and Android users with a single codebase.

My mobile development approach focuses on performance, user experience, and platform-specific guidelines to ensure your app feels native on every device.`,
  ...
  },
  {
    ...
    description: 'Strategic guidance on digital transformation, technology selection, and project planning.',
    long_description: `Help your business navigate the digital landscape with expert consulting services. I provide strategic guidance on technology selection, digital transformation, and project planning to ensure your investments deliver maximum value.

Whether you're looking to modernize legacy systems, choose the right technology stack, or plan a digital transformation initiative, I bring years of experience to help you make informed decisions.`,
    ...
    tools: ['Various technologies', 'Best practices', 'Industry standards', 'Analytics tools'],
    deliverables: [
      'Strategic roadmap',
