...
export function NavBar({ currentPage, onNavigate, isDarkMode, toggleDarkMode }: NavBarProps) {
  ...
  useEffect(() => {
    // Show admin button if accessing admin URL or pressing special key combination
          ...
          <div className="flex items-center space-x-4">
            ...
            {showAdminButton && (
              <Button
                ...
                className="hidden sm:flex items-center space-x-2 border-orange-500 text-orange-600 hover:bg-orange-50 dark:hover:bg-orange-950"
              >
