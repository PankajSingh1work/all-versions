...
type Page = 'home' | 'about' | 'services' | 'projects' | 'certifications' | 'blog' | 'contact' | 'dashboard' | 'admin' | 'project-detail' | 'certification-detail' | 'blog-detail';
...
export default function App() {
  ...
  const showNavAndFooter = currentPage !== 'dashboard' && currentPage !== 'admin';
