...
export const mockCertifications: Certification[] = [
  {
    ...
    certificate_url: 'https://aws.amazon.com/verification/12345',
    status: 'valid',
    created_at: '2024-01-15T10:00:00Z',
    updated_at: '2024-01-15T10:00:00Z',
  ...
  },
  {
    ...
    skills: ['Google Cloud Platform', 'Kubernetes', 'DevOps', 'Containerization', 'Microservices'],
    ...
    certificate_url: 'https://googlecloud.com/verification/67890',
    status: 'valid',
  ...
  },
  {
    ...
    skills: ['React.js', 'JavaScript', 'Frontend Development', 'State Management', 'Performance Optimization'],
    date_earned: '2023-03-20',
    valid_until: null,
    credential_id: 'META-REACT-11223',
    logo_url: 'https://images.unsplash.com/photo-1633356122102-3fe601e05bd2?w=100&h=100&fit=crop',
    certificate_url: 'https://coursera.org/verify/META-REACT-11223',
    status: 'valid',
  ...
  },
  {
    ...
    certificate_url: 'https://cncf.io/verification/CKA-44556',
    status: 'valid',
