...
type Page = 'home' | 'about' | 'services' | 'projects' | 'certifications' | 'blog' | 'contact' | 'dashboard' | 'admin' | 'add-project' | 'add-certificate' | 'add-blog' | 'add-service' | 'update-about' | 'project-detail' | 'certification-detail' | 'blog-detail' | 'admin-setup';
...
export default function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'admin-setup':
        return <AdminSetup onBack={() => handleNavigation('admin')} />;
      case 'services':
  ...
  const showNavAndFooter = currentPage !== 'dashboard' && currentPage !== 'admin' && currentPage !== 'add-project' && currentPage !== 'add-certificate' && currentPage !== 'add-blog' && currentPage !== 'add-service' && currentPage !== 'update-about' && currentPage !== 'admin-setup';
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Show database notice on public pages */}
      {showNavAndFooter && (
        <DatabaseNotice onNavigateToSetup={() => handleNavigation('admin')} />
      )}
