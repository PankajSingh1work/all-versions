...
export const projectsApi = {
  async getAll() {
    try {
      ...
      console.log('Error fetching projects:', error instanceof Error ? error.message : error);
...
export const certificationsApi = {
  async getAll() {
    try {
      ...
      console.log('Server unavailable, using mock data for certifications');  
      console.log('Error fetching certifications:', error instanceof Error ? error.message : error);
...
export const blogApi = {
  async getAll() {
    try {
      ...
      console.log('Server unavailable, using mock data for blog posts');
      console.log('Error fetching blog posts:', error instanceof Error ? error.message : error);
...
export const profileApi = {
  async get() {
    try {
      ...
      console.log('Server unavailable, using mock data for profile');
...
export const servicesApi = {
  async getAll() {
    try {
      ...
      console.log('Server unavailable, using mock data for services');
      console.log('Error fetching services:', error instanceof Error ? error.message : error);
